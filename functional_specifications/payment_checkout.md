...
- Checkout Flow: Standard e-commerce checkout process including cart review, shipping information (for B2B delivery locations), billing information, payment method selection (with conditional Mastercard and Amex availability), and order confirmation.