...
## As a:
Lazy Monkey Customer

## I want to:
Be able to easily increase or decrease the quantity of bananas in my cart using dedicated buttons within the checkout page

## So that:
I can quickly adjust my order without having to manually type in the desired quantity.
...
## Usability:
The "+" and "-" buttons should be clearly visible, easily clickable, and appropriately sized for monkey fingers.

## Mobile Responsiveness:
The buttons should function correctly and maintain visual appeal on all screen sizes (desktop, tablet, mobile).
